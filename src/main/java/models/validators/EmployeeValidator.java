...
/**
 * 従業員インスタンスに設定されている値のバイデーションを行うクラス
 *
 */
public class EmployeeValidator {
     ...
     * @param service EmployeeServiceのインスタンス
     * @param code 社員番号
     * @return 従業員テーブルに登録されている同一社員番号の件数
     */
     ...
     * @param passwordCheckFlag パスワードチェックを実施するかどうか(実施する:true 実施しない:false)
     * @return エラーメッセージ
     */
